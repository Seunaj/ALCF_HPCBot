...
with open('all_polaris_tickets_LLM_GRADED.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open('top100_polaris_tickets_LLM_GRADED.json', 'w', encoding='utf-8') as output_file:
    json.dump(top_samples, output_file, indent=4)

print("Top 100 filtered and ranked samples have been saved to 'top100_polaris_tickets_LLM_GRADED.json'")